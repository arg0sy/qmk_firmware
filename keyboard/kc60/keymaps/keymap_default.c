...
#define F_SPACEFN LT(SPACEFN, KC_SPACE)
#define F_LCTLESC MT(MOD_LCTL, KC_ESC)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE] = KEYMAP(
        ...
        F_LCTLESC, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,           KC_ENT,  \

        KC_LSPO,   KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,                    KC_RSPC, \
        KC_LCTL,   KC_LGUI, KC_LALT,             F_SPACEFN,                       KC_RALT, MO(LED), KC_APP,  KC_RCTL),
    ...
    [LED] = KEYMAP(
        ...
        KC_NO,  KC_NO,  KC_NO,         KC_TRNS,                                 KC_NO,  KC_TRNS, KC_NO, KC_NO),
